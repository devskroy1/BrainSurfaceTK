...
if __name__ == "__main__":
    ...
    for epoch in range(300):
        ...
        for iter, (bg, _) in enumerate(train_dl):
            ...
            # print(batch_labels.shape)
            # bath_labels_unbatched = dgl.unbatch(batch_labels)
            # print("bath_labels_unbatched")
            # print(bath_labels_unbatched)
            # print("bath_labels_unbatched shape")
            # print(bath_labels_unbatched.shape)
            #prediction = model(bg, bg_node_features)
            prediction, topk_node_idxs_batches = model(bg, bg_node_features)
